...
angular.module('viaggia', [
  ...
  .config(function ($stateProvider, $compileProvider, $urlRouterProvider, $translateProvider, $compileProvider, $ionicConfigProvider) {
    ...
    $translateProvider.translations('it', {
      ...
      tracking_notification_title: 'Ferrara Play&go',
      ...
      companies_campaigns:'Campagne di Mobilitá',
    ...
    $translateProvider.translations('en', {
      ...
      companies_campaigns:'Mobility Campaigns',
      ...
      msg_trip_car: 'At {{time}}.<br> {{travelValidity}}, {{points}} points.',
      msg_trip_multimodal: 'At {{time}}.<br> {{travelValidity}}, {{points}} points.',
      msg_trip_boat: 'At {{time}}.<br> {{travelValidity}}, {{points}} points.',
