...
angular.module('viaggia', [
  ...
  .config(function ($stateProvider, $compileProvider, $urlRouterProvider, $translateProvider, $ionicConfigProvider) {
    ...
    $translateProvider.translations('it', {
      ...
      label_warning_corona_title: 'Ripartiamo sicuri',
      label_warning_corona_message: 'Viaggia in modo responsabile: i comportamenti da adottare. Tocca per ulteriori INFO',
      message_popup_first: 'Tocca  ',
      message_popup_second: 'QUI',
      message_popup_third: ' per vedere un breve video che riassume alcune semplici regole, a tutela della sicurezza e della salute dei Clienti e del Personale',
    ...
    $translateProvider.translations('en', {
      ...
      label_warning_corona_title: 'Restart safely',
      label_warning_corona_message: 'Travel responsibly: the behaviors to adopt. Tap here for more INFO',
      message_popup_first: 'Tap  ',
      message_popup_second: 'HERE',
      message_popup_third: ' to see a short video that summarizes some simple rules, to protect the safety and health of Customers and Staff',
